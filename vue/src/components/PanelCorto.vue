<template>
    <div class="item-panel mx-3 flex-grow-1 text-center rounded-20">
        ...
        <div v-if="msg == 'Placa'" class="bg-warning rounded-20 p-3 h-130 justify-content-center d-flex flex-column" id="placa">
            ...
            <form>
                <div>
                    <input class="btn btn-primary text-dark rounded-pill" id="ingresarVehiculo" type="button" value="Ingresar" data-bs-toggle="modal" data-bs-target="#ingresarVehiculoModal">
                    <input class="btn btn-secondary text-dark rounded-pill" id="factura" type="button"
